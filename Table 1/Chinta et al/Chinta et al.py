# -*- coding: utf-8 -*-
"""
Created on Tue Aug 15 15:00:56 2023
...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 15 13:50:51 2023
...
mypath = r"E:\\FDR Predictions DATA\\Chinta et al"
...
for file in tqdm(onlyfiles):
    ...
    for idx in sorted(pops, reverse=True):
        ISI_viol_temp.pop(idx)
        units.pop(idx)
        aligned_units.pop(idx)
    ...
    # no censor period
    pred = JV_utils.pred_FDR(np.stack(PSTHs_temp), ISI_viol_temp, tau=2.5, tau_c=0)
