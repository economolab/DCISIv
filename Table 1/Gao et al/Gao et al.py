# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 14:03:07 2023
...
mypath = r"E:\\FDR Predictions DATA\\Gao et al\\000007"
...
for file in tqdm(onlyfiles):
    ...
    cue_times = nwb_read.trials.cue_time.data[:]
    ...
    pred = JV_utils.pred_FDR(np.stack(PSTHs_temp), ISI_viol_temp, tau_c=0.5)
...
for file in tqdm(onlyfiles):
    ...
    PSTHs_temp = []
    for j, unit in enumerate(units):
        PSTHs_temp.append(JV_utils.gen_PSTH(unit, 1, T, bin_size))
